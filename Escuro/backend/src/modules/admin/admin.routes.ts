...
import {
  ...
  errorResponses,
  loginCreateRequestSchema,
  loginResponseSchema,
  tarefaCreateRequestSchema,
  tarefaResponseSchema,
  relatorioTarefaResponseSchema,
  metodoApiResponseSchema,
  logAdminResponseSchema
...
export async function adminRoutes(app: FastifyInstance) {
  ...
  }, async (request) => listarTarefas(request.query as Record<string, unknown>));
  ...
  }, async (request) => listarRelatorios(request.query as Record<string, unknown>));
  ...
  }, async (request) => listarLogs(request.query as Record<string, unknown>));
}
