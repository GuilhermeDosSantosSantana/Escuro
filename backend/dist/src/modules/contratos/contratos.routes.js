...
import { atualizarContratoPatch, buscarContrato, criarContrato, encerrarContrato, listarContratos, substituirContrato } from "./contratos.service.js";
import { commonErrorResponses, contratoCreateRequestSchema, contratoCreatedResponseSchema, contratoPatchRequestSchema, contratoResponseSchema, errorResponses } from "../../docs/swagger.js";
export async function contratosRoutes(app) {
    ...
    app.get("/api/v1/contratos", {
        ...
        const contratos = await listarContratos(request.query);
